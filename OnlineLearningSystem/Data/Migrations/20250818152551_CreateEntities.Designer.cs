...
namespace OnlineLearningSystem.Data.Migrations
{
    ...
    [Migration("20250818152551_CreateEntities")]
            ...
            modelBuilder.Entity("OnlineLearningSystem.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("OnlineLearningSystem.Models.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("OnlineLearningSystem.Models.Enrollment", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
